                    ...
                    <div className="w-full md:w-[260px] h-full md:border-r border-brand-light/30 p-8 flex flex-col relative z-10 mx-auto">
                        ...
                        <div className="mt-8 md:mt-auto -mx-8 -mb-8 flex flex-col">
                            ...
                            <div className="grid grid-cols-2">
                                <div className="border-t border-r border-b border-brand-light/30 p-4 flex justify-end items-end text-2xl font-light h-20">
                                    <span className="font-bold">01</span><span className="text-[10px] opacity-50 ml-1 mb-1 uppercase tracking-widest">Psy</span>
                                </div>
                                <div className="border-t border-b border-brand-light/30 p-4 flex justify-end items-end text-2xl font-light h-20">
                                    <span className="font-bold">02</span><span className="text-[10px] opacity-50 ml-1 mb-1 uppercase tracking-widest">Mgt</span>
                                </div>
                                <div className="col-span-2 p-4 flex justify-end items-end text-2xl font-light h-16">
                                    <span className="font-bold">03</span><span className="text-[10px] opacity-50 ml-1 mb-1 uppercase tracking-widest">Rsch</span>
                                </div>
                            </div>
                        </div>
                    </div>
